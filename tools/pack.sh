...
# ── per-component knobs ──────────────────────────────────────────────────────
ID=bastion                       # herald package id (== repo name)
NAME="Bastion display manager"   # human-readable name
DESTBIN=bin/bastion              # where the binary installs (verbatim runtime path)
